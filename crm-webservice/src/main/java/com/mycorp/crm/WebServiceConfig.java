...
public class WebServiceConfig extends WsConfigurerAdapter {
	...
	public ServletRegistrationBean messageDispatcherServlet(ApplicationContext applicationContext) {
		...
		return new ServletRegistrationBean(servlet, "/crm/ws/*");
	}
	...
	public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema customerSchema) {
		...
		wsdl11Definition.setTargetNamespace("http://mycorp.com/crm/schema/types");
	...
	public XsdSchema customerSchema() {
		return new SimpleXsdSchema(new ClassPathResource("wsdl/customer.xsd"));
	}
}
